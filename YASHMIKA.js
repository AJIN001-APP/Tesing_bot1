...
async function sessdl() {
  try {
    ...
    const base64Data = sess.SESSION_ID.split("YASHMIKA~")[1];
    if (!base64Data) {
      ...
      conn.sendMessage(conn.user.id, {
        ...
        contextInfo: {
          ...
          externalAdReply: {
            ...
            body: " YASHMIKA OFC 💚",
            mediaType: 1,
            sourceUrl: "https://github.com/ajin001-app",
            thumbnailUrl:
...
if (!app) return;
app.get("/", (req, res) => {
  res.send("Hey I am alive, YS-MD Is started✅");
});
app.listen(port, () =>
